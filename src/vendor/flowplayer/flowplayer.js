/*!
   ...
   Flowplayer v7.1.0 (Monday, 21. August 2017 12:56PM) | flowplayer.com/license
...
(function() {
   ...
   var video = createVideoTag(),
      ...
      s = extend(flowplayer.support, {
        ...
        firstframe: !IS_SILK && !IS_WP && !IS_ANDROID_FIREFOX,
        mutedAutoplay: IS_IPHONE || IS_IPAD || IS_IPAD_CHROME || IS_ANDROID,
...
flowplayer(function(api, root) {
  ...
  if (typeof window.requestAnimationFrame === 'function') {
    var resize = function() {
      common.toggleClass(root, 'is-tiny', root.clientWidth < 400);
      common.toggleClass(root, 'is-small', root.clientWidth < 600 && root.clientWidth >= 400);
